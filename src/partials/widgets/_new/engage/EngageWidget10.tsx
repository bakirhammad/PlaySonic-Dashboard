...
const EngageWidget10 = ({ className }: Props) => (
  <div className={`card card-flush ${className}`}>
    <img src="https://www.dallasjo.com/assets/DALB2C/images/logo.png" />
    <img
      src="https://www.dallasjo.com/assets/DALB2C/images//homebanner.jpg"
      height={"73%"}
    />
    {/* <div
    ...
    >
      ...
      <img
        ...
        src={toAbsoluteUrlForLocalImage("media/illustrations/misc/upgrade.svg")}
        alt=""
      />
      <img
        className="mx-auto h-150px h-lg-200px  theme-dark-show"
        src={toAbsoluteUrlForLocalImage(
          "media/illustrations/misc/upgrade-dark.svg"
        )}
        alt=""
      />
    </div> */}
