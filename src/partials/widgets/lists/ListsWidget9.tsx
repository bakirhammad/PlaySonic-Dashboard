    ...
    <div className={clsx("card", className)}>
      ...
      <div className="card-header align-items-center border-0 mt-3">
        <h3 className="card-title align-items-start flex-column">
          ...
          <span className="text-gray-500 mt-2 fw-bold fs-6">
        ...
        <div className="card-toolbar">
          ...
          >
            <CustomKTIcon iconName="category" className="fs-2" />
          </button>
          <Dropdown1 />
          {/* end::Menu */}
        </div>
      ...
      <div className="card-body pt-5">
        ...
        <div className="d-flex mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img
              src={toAbsoluteUrlForLocalImage("media/stock/600x400/img-3.jpg")}
              className="mw-100"
              alt=""
            />
          </div>
          ...
          <div className="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
            ...
            <div className="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
              ...
              <span className="text-gray-500 fw-bold fs-7 my-1">
                Study highway types
              </span>
        ...
        <div className="d-flex mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img
              src={toAbsoluteUrlForLocalImage("media/stock/600x400/img-4.jpg")}
              className="mw-100"
              alt=""
            />
          </div>
        ...
        <div className="d-flex mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img
              src={toAbsoluteUrlForLocalImage("media/stock/600x400/img-5.jpg")}
              className="mw-100"
              alt=""
            />
          </div>
        ...
        <div className="d-flex mb-7">
          ...
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img
              src={toAbsoluteUrlForLocalImage("media/stock/600x400/img-6.jpg")}
              className="mw-100"
              alt=""
            />
          </div>
        ...
        <div className="d-flex">
          ...
          <div className="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
            <img
              src={toAbsoluteUrlForLocalImage("media/stock/600x400/img-7.jpg")}
              className="mw-100"
              alt=""
            />
          </div>
