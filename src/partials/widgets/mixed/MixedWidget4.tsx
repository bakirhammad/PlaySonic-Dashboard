      ...
      <div className="card-body">
          ...
          <div className="d-flex align-items-center">
            ...
            <div className="symbol symbol-60px me-5">
              <span className={clsx(`symbol-label`, `bg-${color}-light`)}>
                <img
                  src={toAbsoluteUrlForLocalImage(image)}
            ...
            <div className="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
              <a
                href="#"
                className="text-gray-900 fw-bold text-hover-primary fs-5"
              >
                {title}
              </a>
        ...
        <div className="d-flex flex-column mt-10">
          ...
          <div className="d-flex">
            ...
            >
              <img
                src={toAbsoluteUrlForLocalImage("media/avatars/300-6.jpg")}
                alt=""
              />
            </a>
            ...
            >
              <img
                src={toAbsoluteUrlForLocalImage("media/avatars/300-5.jpg")}
                alt=""
              />
            </a>
            ...
            >
              <img
                src={toAbsoluteUrlForLocalImage("media/avatars/300-10.jpg")}
                alt=""
              />
            </a>
          </div>
