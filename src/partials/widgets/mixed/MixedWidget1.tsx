      ...
      <div className="card-body p-0">
        ...
        >
          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <CustomKTIcon iconName="compass" className="fs-1" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <CustomKTIcon iconName="category" className="fs-1" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
          ...
          <div className="d-flex align-items-center mb-6">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <CustomKTIcon iconName="phone" className="fs-1" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
          ...
          <div className="d-flex align-items-center">
            ...
            <div className="symbol symbol-45px w-40px me-5">
              <span className="symbol-label bg-lighten">
                <CustomKTIcon iconName="document" className="fs-1" />
              </span>
            </div>
            {/* end::Symbol */}
            {/* begin::Description */}
