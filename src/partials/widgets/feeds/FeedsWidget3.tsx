      ...
      <div className="card-body pb-0">
        ...
        <div className="d-flex align-items-center mb-3">
          ...
          <div className="d-flex align-items-center flex-grow-1">
            ...
            <div className="symbol symbol-45px me-5">
              <img
                src={toAbsoluteUrlForLocalImage("media/avatars/300-21.jpg")}
                alt=""
              />
            </div>
            {/* end::Avatar */}
        ...
        <div className="mb-7">
          ...
          <div className="d-flex align-items-center mb-5">
            ...
            >
              <CustomKTIcon iconName="message-text-2" className="fs-2" />
              12
            </a>
            ...
            >
              <CustomKTIcon iconName="heart" className="fs-2" />
              150
            </a>
          </div>
          {/* end::Toolbar */}
        ...
        <div className="mb-7 ps-10">
          ...
          <div className="d-flex mb-5">
            ...
            <div className="symbol symbol-45px me-5">
              <img
                src={toAbsoluteUrlForLocalImage("media/avatars/300-14.jpg")}
                alt=""
              />
            </div>
            {/* end::Avatar */}
          ...
          <div className="d-flex">
            ...
            <div className="symbol symbol-45px me-5">
              <img
                src={toAbsoluteUrlForLocalImage("media/avatars/300-9.jpg")}
                alt=""
              />
            </div>
            {/* end::Avatar */}
        ...
        <form className="position-relative mb-6">
          ...
          <div className="position-absolute top-0 end-0 me-n5">
            <span className="btn btn-icon btn-sm btn-active-color-primary pe-0 me-2">
              <CustomKTIcon iconName="message-text-2" className="fs-3 mb-3" />
            </span>

            <span className="btn btn-icon btn-sm btn-active-color-primary ps-0">
              <CustomKTIcon iconName="geolocation" className="fs-2 mb-3" />
            </span>
          </div>
        </form>
        {/* edit::Reply input */}
