        ...
        >
          ...
          <div className="d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-bottom">
            ...
            <div className="d-flex ms-2">
              ...
              <div
                ...
                onClick={handleClose}
              >
                <CustomKTIcon className="fs-1" iconName="cross" />
              </div>
              {/*end::Close*/}
            </div>
          </div>
          ...
          <div className="d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-top">
            ...
            <div className="d-flex align-items-center me-3">
              ...
              >
                <CustomKTIcon className="fs-1" iconName="cloud-add" />
              </a>
              <a href="#" className="btn btn-icon btn-active-light-primary">
                <CustomKTIcon className="fs-1" iconName="geolocation" />
              </a>
              {/*end::Other*/}
            </div>
            {/*end::Actions*/}
            ...
            <div className="d-flex align-items-center">
              <button
                ...
                title="More actions"
              >
                <CustomKTIcon className="fs-1" iconName="setting-2" />
              </button>
            </div>
            {/*end::Toolbar*/}
          </div>
