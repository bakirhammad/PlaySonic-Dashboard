    ...
    <div className="timeline-item">
      ...
      <div className="timeline-icon symbol symbol-circle symbol-40px">
        <div className="symbol-label bg-light">
          <CustomKTIcon iconName="disconnect" className="fs-2 text-gray-500" />
        </div>
      </div>
          ...
          <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
            <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
              <img
                ...
                src={toAbsoluteUrlForLocalImage("media/svg/files/pdf.svg")}
              />
            ...
            <div className="d-flex flex-aligns-center pe-10 pe-lg-20">
              <img
                alt=""
                className="w-30px me-3"
                src={toAbsoluteUrlForLocalImage("media/svg/files/doc.svg")}
              />
            ...
            <div className="d-flex flex-aligns-center">
              <img
                alt=""
                className="w-30px me-3"
                src={toAbsoluteUrlForLocalImage("media/svg/files/css.svg")}
              />
