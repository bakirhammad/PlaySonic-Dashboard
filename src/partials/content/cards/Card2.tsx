...
import { IconUserModel } from "../../../presentation/pages/profile/ProfileModels";
import { UsersList } from "../../../presentation/pages/profile/components/UsersList";
      ...
      <div className="card-header border-0 pt-9">
        <div className="card-title m-0">
          <div className="symbol symbol-50px w-50px bg-light">
            <img
              src={toAbsoluteUrlForLocalImage(icon)}
              alt="card2"
              className="p-3"
            />
          </div>
