    ...
    <>
      <div className="d-flex align-items-center flex-shrink-0 me-5">
        ...
        <div className="symbol-group symbol-hover flex-shrink-0 me-2">
          ...
          <div className="symbol symbol-circle symbol-35px">
            <img
              src={toAbsoluteUrlForLocalImage("media/avatars/300-1.jpg")}
              alt=""
            />
          </div>
          {/* end::User */}
          ...
          <div className="symbol symbol-circle symbol-35px">
            <img
              src={toAbsoluteUrlForLocalImage("media/avatars/300-2.jpg")}
              alt=""
            />
          </div>
          {/* end::User */}
          ...
          <div className="symbol symbol-circle symbol-35px">
            <img
              src={toAbsoluteUrlForLocalImage("media/avatars/300-20.jpg")}
              alt=""
            />
          </div>
          {/* end::User */}
      ...
      <div className="d-flex align-items-center overflow-auto">
        ...
        <div className="d-flex align-items-center">
          ...
          >
            <CustomKTIcon iconName="element-11" className="fs-3 text-primary" />
          </button>
