...
import { SightSeeingTourActionCell } from "./CustomSightSeeingTourActionCell";
...
const SightSeeingTourListColumns: ReadonlyArray<Column<ISightSeeingTourData>> =
  [
    {
    ...
    },
    {
      ...
      Cell: ({ ...props }) => (
        <CustomDescriptionCell
          data={
            props.data[props.row.index]?.translationResponses
              ? props.data[props.row.index]?.translationResponses[0]
                  ?.description
              : "no description"
          }
        />
    ...
    },
    {
      ...
      id: "pickUpTime",
      Cell: ({ ...props }) => (
        <CustomCell data={formatFromUtcToLocale(props.data[props.row.index]?.pickUpTime,"HH:mm")} />
      ),
    },
...
export { SightSeeingTourListColumns };
