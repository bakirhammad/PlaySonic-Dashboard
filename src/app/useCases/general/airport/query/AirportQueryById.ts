import { IAirportData, IAirportQueryById } from "@domain/entities";
...
export class AirportQueryById implements IAirportQueryById, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) {}

  async getAirportById(url: string, id: number): Promise<IAirportData> {
...
export const AirportQueryByIdInstance = new AirportQueryById(
  makeAxiosHttpClient()
);
