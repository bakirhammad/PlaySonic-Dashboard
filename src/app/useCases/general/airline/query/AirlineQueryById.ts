import { IAirlineData, IAirlineQueryById } from "@domain/entities";
...
export class AirlineQueryById implements IAirlineQueryById, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) {}

  async getAirlineById(url: string, id: number): Promise<IAirlineData> {
...
export const AirlineQueryByIdInstance = new AirlineQueryById(
  makeAxiosHttpClient()
);
