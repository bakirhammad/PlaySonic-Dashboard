import { IAirlineBody, IAirlineQuery } from "@domain/entities";
...
export class AirlineQuery implements IAirlineQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) {}

  async getAirlineList(url: string): Promise<IAirlineBody> {
...
export const AirlineQueryInstance = new AirlineQuery(makeAxiosHttpClient());
