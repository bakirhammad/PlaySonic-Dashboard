...
import { ICountryBody, ICountryQuery } from "@domain/entities";
...
export class CountryQuery implements ICountryQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getCountryList(url: string): Promise<ICountryBody> {
...
export const CountryQueryInstance = new CountryQuery(makeAxiosHttpClient());
