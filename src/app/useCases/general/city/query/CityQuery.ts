...
export class CityQuery implements ICityQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getCityList(url: string): Promise<ICityBody> {
...
export const CityQueryInstance = new CityQuery(makeAxiosHttpClient());
