import { IZoneBody, IZoneQuery } from "@domain/entities";
...
export class ZoneQuery implements IZoneQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getZoneList(url: string): Promise<IZoneBody> {
...
export const ZoneQueryInstance = new ZoneQuery(makeAxiosHttpClient());
