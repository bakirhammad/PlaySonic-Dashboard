import { IZoneData, IZoneQueryById } from "@domain/entities";
...
export class ZoneQueryById implements IZoneQueryById, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getZoneById(url: string, id: number): Promise<IZoneData> {
...
export const ZoneQueryByIdInstance = new ZoneQueryById(makeAxiosHttpClient());
