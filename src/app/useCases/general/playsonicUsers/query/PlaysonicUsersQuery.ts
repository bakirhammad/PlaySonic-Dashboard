import { IPlaysonicUsersBody, IPlaysonicUsersQuery } from "@domain/entities/general/PlaysonicUsers/PlaysonicUsers";
...
export class PlaysonicUsers implements IPlaysonicUsersQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getPlaysonicUsersList(url: string): Promise<IPlaysonicUsersBody> {
...
export const PlaysonicUsersQueryInstance = new PlaysonicUsers(
  makeAxiosHttpClient()
);
