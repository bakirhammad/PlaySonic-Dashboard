import { IImageBannerBody, IImageBannerQuery } from "@domain/entities/general/ImageBanner/ImageBanner";
...
export class ImageBannerQuery implements IImageBannerQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getImageBannerList(url: string): Promise<IImageBannerBody> {
...
export const ImageBannerQueryInstance = new ImageBannerQuery(
  makeAxiosHttpClient()
);
