import { IRolesData, IRolesQueryById } from "@domain/entities/general/Roles/Roles";
...
export class RolesQueryById
  implements IRolesQueryById, IQuery {
...
export const RolesQueryByIdInstance =
  new RolesQueryById(makeAxiosHttpClient());
