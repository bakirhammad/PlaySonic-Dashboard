import { IRolesBody, IRolesQuery } from "@domain/entities/general/Roles/Roles";
...
export class RolesQuery implements IRolesQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getRolesList(url: string): Promise<IRolesBody> {
...
export const RolesQueryInstance = new RolesQuery(
  makeAxiosHttpClient()
);
