import { IAddUsersBody, IAddUsersQuery } from "@domain/entities/general/AddUsers/AddUsers";
...
export class AddUsersQuery implements IAddUsersQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getAddUsersList(url: string): Promise<IAddUsersBody> {
...
export const AddUsersQueryInstance = new AddUsersQuery(
  makeAxiosHttpClient()
);
