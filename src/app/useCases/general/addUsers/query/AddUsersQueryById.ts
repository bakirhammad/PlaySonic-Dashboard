import { IAddUsersData, IAddUsersQueryById } from "@domain/entities/general/AddUsers/AddUsers";
...
export class AddUsersQueryById
  implements IAddUsersQueryById, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getAddUsersById(
    url: string,
    userId: number
...
export const AddUsersQueryByIdInstance =
  new AddUsersQueryById(makeAxiosHttpClient());
