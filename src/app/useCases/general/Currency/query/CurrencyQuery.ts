import { ICurrencyBody, ICurrencyQuery } from "@domain/entities";
...
export class CurrencyQuery implements ICurrencyQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getCurrencyList(url: string): Promise<ICurrencyBody> {
...
export const CurrencyQueryInstance = new CurrencyQuery(makeAxiosHttpClient());
