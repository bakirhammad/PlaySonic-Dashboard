import { ICurrencyData, ICurrencyQueryById } from "@domain/entities";
...
export class CurrencyQueryById implements ICurrencyQueryById, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getCurrencyById(
    url: string,
    id: number | string
  ): Promise<ICurrencyData> {
...
export const CurrencyQueryByIdInstance = new CurrencyQueryById(
  makeAxiosHttpClient()
);
