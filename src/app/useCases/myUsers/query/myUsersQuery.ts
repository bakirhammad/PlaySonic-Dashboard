import { IMyUsersBody, IMyUsersQuery } from "@domain/entities/MyUsers/MyUsers";
...
export class MyUsers implements IMyUsersQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getMyUsersList(url: string): Promise<IMyUsersBody> {
...
export const MyUsersQueryInstance = new MyUsers(
  makeAxiosHttpClient()
);
