import { ICourtSlotsBody, ICourtSlotsQuery } from "@domain/entities/CourtSlot/CourtSlot";
...
export class CourtSlotsQuery implements ICourtSlotsQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getCourtSlotsList(url: string): Promise<ICourtSlotsBody> {
...
export const CourtSlotsQueryInstance = new CourtSlotsQuery(
  makeAxiosHttpClient()
);
