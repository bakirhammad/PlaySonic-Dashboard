import {
  ISightSeeingCategoryQuery,
  ISightSeeingCategoryBody,
...
export class SightSeeingCategoryQuery
  implements ISightSeeingCategoryQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getSightSeeingCategoryList(
    url: string
  ): Promise<ISightSeeingCategoryBody> {
...
export const SightSeeingCategoryQueryInstance = new SightSeeingCategoryQuery(
  makeAxiosHttpClient()
);
