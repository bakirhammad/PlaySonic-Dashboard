...
export class SightSeeingTourRateQueryById
  implements ISightSeeingTourRateQueryById, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getSightSeeingTourRateById(
    url: string,
    id: number
...
export const SightSeeingTourRateQueryByIdInstance =
  new SightSeeingTourRateQueryById(makeAxiosHttpClient());
