import { IClubBody, IClubQuery } from "@domain/entities/Clubs/Clubs";
...
export class ClubQuery implements IClubQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getClubList(url: string): Promise<IClubBody> {
...
export const ClubQueryInstance = new ClubQuery(
  makeAxiosHttpClient()
);
