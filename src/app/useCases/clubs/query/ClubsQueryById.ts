import { IClubData, IClubQueryById } from "@domain/entities/Clubs/Clubs";
...
export class ClubQueryById
  implements IClubQueryById, IQuery {
...
export const ClubQueryByIdInstance =
  new ClubQueryById(makeAxiosHttpClient());
