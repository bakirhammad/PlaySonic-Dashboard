...
export class ClubCommand implements IClubCommand, ICommand {
  constructor(private readonly httpPostClient: IHttpClient) {}

  async createClub(url: any, body: any): Promise<IClubData> {
  ...
  async updateClub(url: any, body: any): Promise<IClubData> {
  ...
  async deleteClub(url: string, id: number): Promise<IClubData> {
  ...
  async multipleDeleteClub(url: string, ids: number[]): Promise<IClubData> {
    const httpResponse = await this.httpPostClient.deleteRequest({
      url,
      body: ids,
    });
  ...
  async deleteClubImage(url: string, id: number): Promise<IClubData> {
    const httpResponse = await this.httpPostClient.deleteRequest({
      url,
      body: {
        id,
...
export const ClubCommandInstance = new ClubCommand(makeAxiosHttpClient());
