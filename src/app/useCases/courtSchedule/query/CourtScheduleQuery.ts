import { ICourtScheduleBody, ICourtScheduleQuery } from "@domain/entities/CourtSchedule/CourtSchedule";
...
export class CourtScheduleQuery implements ICourtScheduleQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getCourtScheduleList(url: string): Promise<ICourtScheduleBody> {
...
export const CourtScheduleQueryInstance = new CourtScheduleQuery(
  makeAxiosHttpClient()
);
