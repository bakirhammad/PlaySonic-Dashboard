...
import { ICommerceCommand, ICommerceData } from "@domain/entities/Commerce/Commerce";
...
export class CommerceCommand
  implements ICommerceCommand, ICommand {
...
export const CommerceCommandInstance = new CommerceCommand(
  makeAxiosHttpClient()
);
