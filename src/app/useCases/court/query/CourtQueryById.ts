import { ICourtData, ICourtQueryById } from "@domain/entities/Court/Court";
...
export class CourtQueryById
  implements ICourtQueryById, IQuery {
...
export const CourtQueryByIdInstance =
  new CourtQueryById(makeAxiosHttpClient());
