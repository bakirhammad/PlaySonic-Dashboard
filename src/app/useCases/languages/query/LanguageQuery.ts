import { ILanguage, ILanguageQuery } from "@domain/entities/language/Language";
...
export class LanguageQuery implements ILanguageQuery, IQuery {
  constructor(private readonly httpPostClient: IHttpClient) { }

  async getLanguageList(url: string): Promise<ILanguage[]> {
